...
ae_total = alt.Chart(subset
        ...
        alt.X('total_count:Q', scale = alt.Scale(type = 'linear'), axis = alt.Axis(grid = False), title = 'Adverse event frequency (log scale)'),
...
ae_freq = alt.Chart(subset).mark_bar().encode(
    ...
    alt.Y('count:Q', scale = alt.Scale(type = 'linear'), axis = alt.Axis(grid = False), title = 'Frequency (log scale)'),
...
ae_prop = alt.Chart(subset).mark_bar(
        ...
        alt.X('vaccine:N', axis = alt.Axis(title = None, labels = False)),
        alt.Y('event_percent:Q', scale = alt.Scale(type = 'linear'), axis = alt.Axis(grid = False), title = 'Proportion of adverse events (%, log scale)'),
        alt.Column('event_type:N', header = alt.Header(titleOrient = 'bottom', labelOrient = 'bottom', labelColor = 'white'), title = ''),
        alt.Color('vaccine:N')
